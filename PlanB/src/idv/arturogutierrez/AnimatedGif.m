...
- (void) asynchronousLoading
{
	...
	while ([imageQueue count] > 0)
    {
    	...
    	[imageView setFrame:CGRectMake((imageView.superview.frame.size.width-tempImageView.image.size.width/2)/2,(imageView.superview.frame.size.height-tempImageView.image.size.height/2)/2 , tempImageView.image.size.width/2, tempImageView.image.size.height/2)];
